...
The next code describe the function to generate a sinusoidal reference
...
\begin{lstlisting}[language=Python,caption=Ros node to move the second and fifth joint of ur5 robot.]
#!/usr/bin/env python3
# =============
#   Libraries
# ============= 
